...
export function ProfileHighlights({ highlights }: { highlights: { id: string; title: string; coverUrl: string }[] }) {
  return (
    <section className="space-y-2 rounded-3xl border border-white/10 bg-white/[0.03] p-3">
      ...
      <div className="flex gap-3 overflow-x-auto pb-1">
        {highlights.map((highlight) => (
          <button key={highlight.id} type="button" className="min-w-[72px] max-w-[80px] space-y-1">
            <Image
